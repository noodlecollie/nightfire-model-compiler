...
namespace JbnLib.Qc
{
    public class CommandSequenceV44
    {
        ...
        public CommandSequenceV10 ToV10()
        {
            ...
            if (_Activity != null)
                output.Activity = new OptionActivityV10((ActivityV10)Enumerators.ConvertActivity(typeof(ActivityV44), typeof(ActivityV10), _Activity.Activity), _Activity.ActivityWeight);
