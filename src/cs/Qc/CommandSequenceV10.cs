...
namespace JbnLib.Qc
{
    public class CommandSequenceV10
    {
        ...
        public CommandSequenceV44 ToV44()
        {
            ...
            if (_Activity != null)
                output.Activity = new OptionActivityV44((ActivityV44)Enumerators.ConvertActivity(typeof(ActivityV10), typeof(ActivityV44), _Activity.Activity), _Activity.ActivityWeight);
            output.Animation = _Animation;
            output.BlendCollection = _BlendCollection;
            output.Control = _Control;
            output.EventCollection = _EventCollection;
