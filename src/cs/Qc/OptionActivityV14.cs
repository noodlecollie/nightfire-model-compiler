...
namespace JbnLib.Qc
{
    ...
    public enum ActivityV14 : int
    {
        ...
        ACT_DIEFORWARD = 38,
        ACT_DIEVIOLENT = 39,
        ACT_BLINDED = 40,		    // USED TO BE: ACT_BARNACLE_HIT
        ...
        ACT_FLINCH_RIGHTLEGUPPER = 77,
        ACT_FLINCH_BACK = 78,
        ACT_FLINCH_LEFTARMLOWER = 79,
        ACT_FLINCH_LEFTARMHAND = 80,
        ACT_FLINCH_RIGHTARMLOWER = 81,
        ACT_FLINCH_RIGHTARMHAND = 82,
        ACT_FLINCH_LEFTLEGLOWER = 83,
        ACT_FLINCH_RIGHTLEGLOWER = 84,
        ACT_HOSTAGE = 85,
        ACT_HOSTAGE_THREAT = 86,
        ACT_DIE_NUTSHOT = 89
    }
}
